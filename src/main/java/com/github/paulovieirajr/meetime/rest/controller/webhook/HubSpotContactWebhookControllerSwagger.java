...
public interface HubSpotContactWebhookControllerSwagger {
    ...
    @Operation(
            summary = "Only Triggered when a contact is created in HubSpot",
            description = "This endpoint is triggered when a contact is created in HubSpot. It receives the contact data and processes it accordingly.")
